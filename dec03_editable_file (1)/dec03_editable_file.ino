...
//PID & errors
float const kp = 0.0067;//5-54-60-65-70
float  const kd = 0.053;//0.018// 28//35// 
...
void junction_find(){
  ...
  if (count>=5){
    ...
    for (uint8_t i = 0;i<no_iterations;i++){ // (14)previous value
      pid_line_following();
      delay(34); // try changint the value here 
    }
